...
Os experimentos foram realizados através da utilização dos seguintes materiais:
\newline
\newline
\textbf{Extração de axiomas de uma ontologia existente}: para realização dos experimentos, alguns axiomas foram extraídos da ontologia NTDO (\textit{Neglected Tropical Disease Ontology} -
Ontologia de Doenças Tropicais Negligenciadas). A ontologia utilizada tem o objetivo de representar um domínio com relevância e impacto reconhecido pela literatura e por instituições de saúde pública. Ela descreve detalhadamente o processo de transmissão de doenças e o falecimento de indivíduos que podem vir a ocorrer a partir da doença transmitida \cite{ntdo}.
\newline
\newline
