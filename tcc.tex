...
\section{Saídas}
\lstinputlisting[language=xml, caption=Saída do Axioma 1] {Axiomas/axioma1.xml}
\lstinputlisting[language=xml, caption=Saída do Axioma 2] {Axiomas/axioma2.xml}
\lstinputlisting[language=xml, caption=Saída do Axioma 3] {Axiomas/axioma3.xml}
\lstinputlisting[language=xml, caption=Saída do Axioma 4] {Axiomas/axioma4.xml}
