...
\begin{table}[H]
\centering
\caption{Gramática da OrCA IDE}
\label{tab:tabelaGramatica}
\begin{tabular}{|l|l|}
\hline Regra  & Definição  \\ 
\hline REGRA1 & \begin{tabular}[l]{@{}l@{}} dskdjfghslkdfjgh sdkfjghs dlkf gjsdlkfgjhsdlfkjgsdfg.\end{tabular} \\
\hline REGRA2 & \begin{tabular}[l]{@{}l@{}} dskdjfghslkdfjgh sdkfjghs dlkf gjsdlkfgjhsdlfkjgsdfg.\end{tabular} \\
\hline REGRA3 & \begin{tabular}[l]{@{}l@{}} dskdjfghslkdfjgh sdkfjghs dlkf gjsdlkfgjhsdlfkjgsdfg.\end{tabular} \\
\hline
\end{tabular}
\end{table} 
